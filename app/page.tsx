...
import { textImageContainerListing } from '@/constants/constants';
import TextCard from '@/components/textCard';
import ImageFrame from '@/components/imageFrame';
import { protoProducts } from '@/constants/constants';
  ...
  return (
    <div id="homepage">
      ...
      <div id="product_categories">
        <div className="w-full p-3 bg-[#E96951] font-extrabold text-3xl text-center text-white">
          PRODUCT CATEGORIES
        </div>
      ...
      >
        <p className="text-3xl font-extrabold">How much could you make</p>
        ...
        >
          <PrototypeCard products={protoProducts} />
      ...
      <div id="sellers-review" className="w-full flex justify-center mt-10 ">
        <div id="sellers-review-title" className="relative inline-block">
          <p className="text-center text-7xl font-extrabold">SELLERS</p>
